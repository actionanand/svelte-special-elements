...
var app = (function () {
    ...
    // (66:0) {#each familyStructure as familyMember (familyMember.name)}
    function create_each_block(key_1, ctx) {
    	...
    	familynode = new FamilyNode({
    			props: { member: /*familyMember*/ ctx[6] },
    			$$inline: true
    		});
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(66:0) {#each familyStructure as familyMember (familyMember.name)}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	let mounted;
    	let dispose;
    	var switch_value = /*renderedComp*/ ctx[1].comp;

    	function switch_props(ctx) {
    		return {
    			props: {
    				id: /*renderedComp*/ ctx[1].id,
    				title: /*renderedComp*/ ctx[1].title
    			},
    			$$inline: true
    		};
    	}
    	...
    	let each_value = /*familyStructure*/ ctx[2];
    	validate_each_argument(each_value);
    	const get_key = ctx => /*familyMember*/ ctx[6].name;
    	...
    	const block = {
    		c: function create() {
    			...
    			each_1_anchor = empty();
    			attr_dev(h1, "class", "capitalize-it svelte-1u8yhsp");
    			add_location(h1, file, 54, 2, 932);
    			attr_dev(div, "class", "title-wrap svelte-1u8yhsp");
    			add_location(div, file, 53, 0, 905);
    			attr_dev(button, "class", "svelte-1u8yhsp");
    			add_location(button, file, 57, 0, 981);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(button, "click", /*toggleComponent*/ ctx[3], false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*renderedComp*/ 2) switch_instance_changes.id = /*renderedComp*/ ctx[1].id;
    			if (dirty & /*renderedComp*/ 2) switch_instance_changes.title = /*renderedComp*/ ctx[1].title;

    			if (switch_value !== (switch_value = /*renderedComp*/ ctx[1].comp)) {
    				if (switch_instance) {
    					group_outros();
    				...
    				if (switch_value) {
    					...
    					mount_component(switch_instance, t4.parentNode, t4);
    				} else {
    			...
    			if (dirty & /*familyStructure*/ 4) {
    				each_value = /*familyStructure*/ ctx[2];
    				validate_each_argument(each_value);
    				group_outros();
    				validate_each_keys(ctx, each_value, get_each_context, get_key);
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	function toggleComponent() {
    		if (renderedComp.comp === Product) {
    			$$invalidate(1, renderedComp = cartObj);
    		} else {
    			$$invalidate(1, renderedComp = prodObj);
    		}
    	}
    	...
    	$$self.$inject_state = $$props => {
    		if ('appName' in $$props) $$invalidate(0, appName = $$props.appName);
    		if ('renderedComp' in $$props) $$invalidate(1, renderedComp = $$props.renderedComp);
    	};
    	...
    	return [appName, renderedComp, familyStructure, toggleComponent];
    }
