...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 30, 2, 524);
    			attr_dev(div, "class", "title-wrap svelte-1u8yhsp");
    			add_location(div, file, 29, 0, 497);
    			attr_dev(button, "class", "svelte-1u8yhsp");
    			add_location(button, file, 33, 0, 573);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(button, "click", /*toggleComponent*/ ctx[2], false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	return [appName, renderedComp, toggleComponent];
    }
