...
var app = (function () {
    ...
    /* src/CartItem.svelte generated by Svelte v3.46.3 */
    ...
    /* src/FamilyNode.svelte generated by Svelte v3.46.3 */
    ...
    // (9:4) {#each member.children as child}
    function create_each_block$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(9:4) {#each member.children as child}",
    		ctx
    	});
    ...
    function create_each_block(key_1, ctx) {
    	...
    	familynode = new FamilyNode({
    			props: { member: /*familyMember*/ ctx[11] },
    			$$inline: true
    		});
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(83:2) {#each familyStructure as familyMember (familyMember.name)}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	document.title = title_value = /*currentTitle*/ ctx[3];
    	var switch_value = /*renderedComp*/ ctx[2].comp;

    	function switch_props(ctx) {
    		return {
    			props: {
    				id: /*renderedComp*/ ctx[2].id,
    				title: /*renderedComp*/ ctx[2].title
    			},
    			$$inline: true
    		};
    	}
    	...
    	let each_value = /*familyStructure*/ ctx[4];
    	validate_each_argument(each_value);
    	const get_key = ctx => /*familyMember*/ ctx[11].name;
    	...
    	const block = {
    		c: function create() {
    			...
    			button1.textContent = "Change website title";
    			t7 = space();
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(document.body, "mouseenter", /*mouseenter_handler*/ ctx[8], false, false, false),
    					listen_dev(button0, "click", /*toggleComponent*/ ctx[5], false, false, false),
    					listen_dev(button1, "click", /*changeMyTitle*/ ctx[6], false, false, false)
    				];
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if ((!current || dirty & /*currentTitle*/ 8) && title_value !== (title_value = /*currentTitle*/ ctx[3])) {
    				document.title = title_value;
    			}

    			const switch_instance_changes = {};
    			if (dirty & /*renderedComp*/ 4) switch_instance_changes.id = /*renderedComp*/ ctx[2].id;
    			if (dirty & /*renderedComp*/ 4) switch_instance_changes.title = /*renderedComp*/ ctx[2].title;

    			if (switch_value !== (switch_value = /*renderedComp*/ ctx[2].comp)) {
    				if (switch_instance) {
    					group_outros();
    			...
    			if (dirty & /*familyStructure*/ 16) {
    				each_value = /*familyStructure*/ ctx[4];
    				validate_each_argument(each_value);
    				group_outros();
    				validate_each_keys(ctx, each_value, get_each_context, get_key);
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	function toggleComponent() {
    		if (renderedComp.comp === Product) {
    			$$invalidate(2, renderedComp = cartObj);
    		} else {
    			$$invalidate(2, renderedComp = prodObj);
    		}
    	}

    	function changeMyTitle() {
    		$$invalidate(3, currentTitle = 'Svelte App\'s title changed!');
    	}
    	...
    	const mouseenter_handler = () => console.log(event);
    	...
    	$$self.$inject_state = $$props => {
    		if ('appName' in $$props) $$invalidate(0, appName = $$props.appName);
    		if ('renderedComp' in $$props) $$invalidate(2, renderedComp = $$props.renderedComp);
